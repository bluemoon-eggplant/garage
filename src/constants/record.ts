...
export const CLASSIFICATION_KEYWORDS: Record<string, string[]> = {
  ...
  consumable: [
    'エンジンオイル', 'オイル交換', 'ROTARY-1', '5W-30', 'オイルエレメント', 'オイルフィルター交換',
    'エアエレメント', 'エアークリーナー',
