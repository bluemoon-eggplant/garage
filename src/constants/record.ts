...
export const CLASSIFICATION_KEYWORDS: Record<string, string[]> = {
  ...
  interior: [
    'ダッシュボード', 'シフトレバー', 'シフトブーツ', 'グローブボックス',
    ...
    'モールディング', 'Fモール', 'メッキモール', 'ベルトライン', 'ガーニッシュ', 'ガラス・テン・チャンネル', 'ドライブレコーダー', 'フロアマット', 'コーナーパネル', 'トノカバー', '幌カバー',
  ],
  bodywork: [
    '板金', '塗装', 'パネル', 'バンパー',
  ],
  braking: [
    'ブレーキ', 'ブレーキディスク', 'ブレーキパッド', 'ゴールデンパッド', 'キャリパー', 'キャリバー', 'マスターシリンダー', 'ブレーキマスターシリンダー', 'ディクセル',
  ],
  suspension: [
...
export const CONSUMABLE_TAG_EXCLUSIONS: string[] = [
  '漏れ', '洗浄', '点検', 'テスト', '診断', '液補充', 'ご希望', '弱い', '燃焼状態', '汚れ', 'ホースバンド', 'カバー', 'ターミナル',
];
